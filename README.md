...
3. `docs/` —— 新版深色 CAD / 节点网络工作台原型,作为 GitHub Pages 展示入口。
4. `预览图/` —— UI 设计稿(深色「控制台」与浅色「实验台」两套主题)。

生产级平台(多层引擎 + 元件库 + 单页应用)正按规划里的路线图推进。

## 在线预览

新版通用平台工作台原型将通过 GitHub Pages 发布:

<https://bulbel-magnolia.github.io/bionet-studio/>

该原型仍是高保真前端阶段,所有示例数据均为 illustrative / to be calibrated。水质检测只作为 example project,不是平台本体的固定领域。
